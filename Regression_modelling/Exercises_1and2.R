...
# We will load data from the Framingham study.  This is a long-term cohort study into the risks around
# cardiovascular disease, based around the US city of Framingham.  This is an open dataset, available
# for reuse.
...
# We will look at systolic blod pressure: sysBP
# Let look at the distribution
...
# Visualise it as a scatter plot first
...
# Is BMI 'signficant'?  Yes, p-value is very low ( < 0.05 for common 95% criterion)
#  How much variation doe sit represent?  10.7%
...
# Lets considers some more variables: currentSmoker, age, education
