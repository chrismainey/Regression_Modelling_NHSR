...
```{r lm3, fig.align="center", fig.height=4.8, fig.retina=2, fig.width=6, message=FALSE, warning=FALSE}
z <- lm(y~x)
...
```{r lm2, fig.align="center", fig.height=5, fig.retina=2, fig.width=6, message=FALSE, warning=FALSE}
...
+ Models won't understand text, and numbers are numeric
