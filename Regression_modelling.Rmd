...
+ ___"Take away the mean, and divide by standard deviation (z-score)."___
...
+ If we provide a numered category, `R` sees it as numeric
--

`Factors` are 'dummy coded:' 
+ _pivotted to binary columns_
+ Contain a reference level
--
...
- `family` argument with `poisson` for counts or `binomial` for binary outcomes.
