...
```{r lm2, fig.align="center", fig.height=3, fig.width=6, message=FALSE, warning=FALSE}
...
+ We created an `lm` object called `z`.  Can use this object with other functions like `summary`, `predict`, `plot` etc.
...
```{r lmplot, echo=FALSE,  fig.keep = 'last'}
par(mfrow=c(2,2))
plot(z)
```
